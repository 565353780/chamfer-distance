...
class SidedSpeedManager(object):
    ...
    def getAlgosFPSDiff(
        ...
        fps_1 = SidedSpeedManager.getAlgoFPS(
            algo_name_1,
            xyz1,
            xyz2,
            max_test_second,
        ...
        fps_2 = SidedSpeedManager.getAlgoFPS(
            algo_name_2,
            xyz1,
            xyz2,
            max_test_second,
    ...
    def getAlgosFPSDiffSimple(
        ...
        return SidedSpeedManager.getAlgosFPSDiff(
            algo_name_1,
            algo_name_2,
            xyz1,
            xyz2,
    ...
    def getAlgoFPSDict(
        ...
        for algo_name in algo_name_list:
            algo_fps = SidedSpeedManager.getAlgoFPS(
                algo_name,
                xyz1,
                xyz2,
                max_test_second,
    ...
    def getAlgoSimpleFPSMapDict(
        ...
        for m, n in xy_pairs:
            print("[INFO][SidedSpeedManager::getAlgoFPSMapDict]")
    ...
    def getAlgoBalanceFPSMapDict(
        ...
        for m, n in xy_pairs:
            ...
            algo_fps_dict = SidedSpeedManager.getAlgoFPSDict(
                xyz1_shape,
                xyz2_shape,
                max_test_second,
                warmup,
    ...
    def getAlgosEqualFPSPoint(
        ...
        if not SidedDistances.isAlgoNameValid(algo_name_1):
            print("[ERROR][SidedSpeedManager::getAlgosEqualFPSPoint]")
            print("\t namedAlgo failed for algo name 1!")
            return None
        if not SidedDistances.isAlgoNameValid(algo_name_2):
            print("[ERROR][SidedSpeedManager::getAlgosEqualFPSPoint]")
            print("\t namedAlgo failed for algo name 2!")
            return None

        def fpsDiff(calculation_num: float) -> float:
            fps_diff = SidedSpeedManager.getAlgosFPSDiffSimple(
                algo_name_1,
                algo_name_2,
                calculation_num,
                max_test_second,
    ...
    def saveEqualFPSPoint(
        ...
        save_equal_fps_point_txt_file_path: str = SIDED_ALGO_EQUAL_FPS_POINT_TXT_FILE_PATH,
    ) -> bool:
